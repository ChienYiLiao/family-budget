  ...
  function _guideHTML() {
    const sections = [
      ...
      },
      {
        ...
        desc: '點「記帳」→「🔁 固定」Tab，可看到所有啟用中的固定項目。點擊後彈出確認視窗，金額可直接修改，適合水電費等每月金額不固定的項目。'
      },
      {
        icon: '⚙️', title: '固定收支管理',
        desc: '點「記帳」→「🔁 固定」Tab，點右上角「管理 →」進入管理頁面，可新增、啟用/停用、刪除固定項目。固定支出類別：房貸、房租、電話費、定期定額股票、現金儲蓄。'
      },
      {
        icon: '📋', title: '歷史記錄',
      ...
      {
        icon: '📊', title: '統計分析',
        desc: '點底部「統計」查看豬豬／滾滾／共同的收支對比、月趨勢圖、支付方式佔比、類別排名與本期 Top 10 大額消費。可勾選「排除固定收支」看日常開銷。點「產生月報表」可選月份範圍後匯出至 Google Sheets。'
      },
      {
        icon: '🖼️', title: '更換頭像',
